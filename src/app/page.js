  ...
  return <main className="flex min-h-screen flex-col items-center justify-center p-4">
    <div className="w-full max-w-md space-y-8">
      <div className="text-center space-y-2">
        ...
        <p className="text-shadow-zinc-700 texd-md">
          A private chat app that works without a server. All data is stored in your browser and never leaves your device.
        </p>
      </div>
      ...
      <div className="space-y-5">
        <div className="space-y-2">
          <label className="flex-items-center text-zinc-502">
            Your Identity
